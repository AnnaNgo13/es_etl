...
def mapping(input_record):
    ...
    try: 
        # if "data-temperature" in test_record:
        #     if input_record["data-temperature"] is not None:
        #         output_record["measureType"] = "1"
        #         output_record["measureName"] = "temperature"
        #         output_record["measureValue1"] = float(input_record["data-temperature"])
